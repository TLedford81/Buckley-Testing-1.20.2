...
public class KetamineSword extends SwordItem {
    public KetamineSword(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
